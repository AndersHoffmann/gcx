...
const (
	checkResultType          = "gcx.aio11y.experiment_check"
...
// reportExperiment resolves the experiment record of a report. The server sends
// it under "experiment"; older payloads used "run".
func reportExperiment(report *ExperimentReport) Experiment {
